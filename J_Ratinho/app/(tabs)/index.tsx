    ...
    <View style={local.container}>
      <View style={local.header}>
        ...
        <Link style={local.profile} href="/profile">
          <Avatar.Image
            size={40}
            source={require("@/assets/images/rato.png")}
          />
        </Link>
      </View>
      <Text variant="headlineLarge">Bem vindo, aluno!</Text>
      <Text style={{ marginBottom: 32 }} variant="titleMedium">
        Vamos aprender e se divertir?
      </Text>

      <ExerciceCard
        InstrumentVariant="saxofone"
        InstrumentSize={200}
        InstrumentRotation="-30deg"
        MainColor={Colors.dark.orange}
        CoverColor={Colors.light.orange}
        TextColor="#ffffff"
      ></ExerciceCard>
